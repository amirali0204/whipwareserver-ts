...
import {MongoSingleton} from "../../Builder/mongooseSingleton";
import {DBObjectCreator} from "../../ObjectsFactory/DBObjects/DBObjectCreator";
import {DBObjectQueriesCreator} from "../../ObjectsFactory/DBObjects/DBObjectQueriesCreator";
...
export class DBActions implements ActionInterface {
    ...
    public async execute(): Promise<object | undefined> {
        ...
        ObjectsFactory = new DBObjectCreator(this.m_Function);
        let dbObject = {};
        ...
        switch (this.SysAction.toUpperCase()) {
            ...
            //    console.log("Here all Custom function Handled" + this.SysAction + "Queries");
                let ObjectsFactory_2: ObjectCreator;
                ObjectsFactory_2 = new DBObjectQueriesCreator(this.m_Function + "Queries");
                let allQueries = {};
                allQueries = ObjectsFactory_2.createObject();
