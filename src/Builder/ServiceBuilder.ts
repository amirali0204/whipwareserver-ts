...
import {MongoSingleton} from "./mongooseSingleton";
export class DVBuilder {
    ...
    public async validateAdminEnterprise() {
        ...
        ObjectsFactory = new DBObjectCreator(m_Function);
        let dbObject = {};
        ...
        await query.then(( result) => {
          ...
          if (result === null) {
            ...
            ObjectsFactory = new DBObjectCreator(DBAppName);
            let AppdbObject = {};
            ...
            ObjectsFactory = new DBObjectCreator(DBUserName);
            let UserdbObject = {};
            ...
            ObjectsFactory = new DBObjectCreator(DBObjectName);
            let dbObject = {};
            dbObject = ObjectsFactory.createObject();
