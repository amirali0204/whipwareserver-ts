    ...
    validateAdminEnterprise() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            */
            ...
            DVObjectsFactory = new DBObjectCreator_1.DBObjectCreator(m_Function);
            let dbObject = {};
            ...
            yield query.then((result) => {
                ...
                if (result[EnterpriseName] === undefined) {
                    ...
                    DVObjectsFactory = new DBObjectCreator_1.DBObjectCreator(DBAppName);
                    let AppdbObject = {};
                    ...
                    DVObjectsFactory = new DBObjectCreator_1.DBObjectCreator(DBUserName);
                    let UserdbObject = {};
                    ...
                    DVObjectsFactory = new DBObjectCreator_1.DBObjectCreator(DBObjectName);
                    let dbObject = {};
                    dbObject = DVObjectsFactory.createObject();
