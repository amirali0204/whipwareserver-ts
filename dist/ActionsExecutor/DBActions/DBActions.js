...
const mongooseSingleton_1 = require("../../Builder/mongooseSingleton");
const DBObjectCreator_1 = require("../../ObjectsFactory/DBObjects/DBObjectCreator");
const DBObjectQueriesCreator_1 = require("../../ObjectsFactory/DBObjects/DBObjectQueriesCreator");
...
class DBActions {
    ...
    execute() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let ObjectsFactory;
            ObjectsFactory = new DBObjectCreator_1.DBObjectCreator(this.m_Function);
            let dbObject = {};
            ...
            switch (this.SysAction.toUpperCase()) {
                ...
                default: {
                    ...
                    let ObjectsFactory_2;
                    ObjectsFactory_2 = new DBObjectQueriesCreator_1.DBObjectQueriesCreator(this.m_Function + "Queries");
                    let allQueries = {};
